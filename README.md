...
<h1 style="font-size: 3em; color: #FF0000;">•  PROYECTOS DE APIs HECHAS CON LOS LENGUAJES DE PROGRAMACION PYTHON, JAVASCRIPT Y GO  </h1> 
...
Luego de descargar git, Se puede descargar estos archivos dando click en el boton verde y en dowload pero tambien se puede hacer con los siguientes comandos de terminal en cualquier sistema operativo que ya tenga descargado el git.
